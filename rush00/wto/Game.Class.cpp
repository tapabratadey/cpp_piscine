...
int **Game::getEnemiesMap() { return enemies; }
int **Game::getBulletsMap() { return bullets; }

void Game::moveBullets(struct BulletPos *bulletPos)
{ bulletPos->y--; }

void Game::addBullet(struct BulletPos *bulletPos)
{ 
    bullets[position->x][position->y] = new Bullets*[];//the pos to player
    moveBullets(bulletPos);
